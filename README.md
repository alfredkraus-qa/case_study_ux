# PeTinder: Conectando pessoas e ONGs para adoção de animais 🐶
...
## Etapas do Processo - Descoberta, Definição e Idealização

Este documento abaixo detalha todas as etapas do processo de descoberta, definição e idealização aplicadas na criação do aplicativo PeTinder. A abordagem foi baseada em metodologias como: desk research, matriz csd, pesquisas quantitativas e qualitativas, entrevistas com usuários, mapeamento de experiência, prototipação e teste de usabilidade. 
...
No desenvolvimento do PeTinder, a prototipação foi essencial para dar vida às ideias: foi criado inicialmente wireframes de esboço e baixa fidelidade para estruturar telas como o cadastro de usuários e a visualização dos animais para adoção.

<img width="6048" alt="wireframe esboço - MERGO" src="https://github.com/user-attachments/assets/d7d1bca0-59f4-42fe-ad4f-4eb89e24ade6" />

![image](https://github.com/user-attachments/assets/ca9cc1ff-b71a-48a9-91a9-fda209b12e45)

Deste modo, foi desenvolvido protótipos interativos de alta fidelidade para simular a experiência completa, incluindo fluxo de cadastro do usuário e de adoção do animal indo até página de contato com a ONG.

![image](https://github.com/user-attachments/assets/8541af6f-ce50-403e-9ea7-4b4b97a4a2f2)
![image](https://github.com/user-attachments/assets/324609c4-cedf-489d-8959-ddd01d99c0f3)

Por fim, para garantir que o PeTinder atendesse às necessidades dos usuários, foi realizado os seguintes testes:

• Testado o protótipo com usuários reais (adotantes e representantes de ONGs).

• Pedi que executassem tarefas específicas, como fazer o cadastro, dar um 'match' com o animal e iniciar contato com a ONG.

• Coleta de feedback para identificar problemas, como a dificuldade de entrar na página 'Lojas Parceiras' e pedidos para ter uma documentação que comprove que o pet foi adotado.
